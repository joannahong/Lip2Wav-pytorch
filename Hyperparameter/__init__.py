...
from Combiner.FMCSelector import FMCSelector

class HyperParameter():
    hp_name = "Base Hyper Parameters"

    fmc = FMCSelector.FMesh_Whole_Face
    ...
    def updateParams(self):
        self.log_dir = os.path.join(self.current_result_dir, 'logger_dir')
        self.checkpoint_dir = os.path.join(self.current_result_dir, 'ckpt_dir')
        self.load_checkpoint_path = os.path.join(self.result_dir,
                                                 "{}/ckpt_dir/ckpt_{:05d}.pt".format(self.load_ckpt_name, self.load_ckpt_epoch))
        self.num_landmarks = self.fmc.landmark_count